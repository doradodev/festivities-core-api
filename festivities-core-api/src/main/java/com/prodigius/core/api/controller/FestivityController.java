...
public class FestivityController {
	...
	@ApiOperation(value = "Get festivities", notes = "Find all Festivities according to a query search parameters", response = Festivity.class, produces = APPLICATION_JSON_VALUE, consumes = APPLICATION_JSON_VALUE)
    @ApiResponses({
        @ApiResponse(code = 200, message = "All Festivities according to a query search parameters"),
    ...
    public ResponseEntity<Page<Festivity>> festivities(
    ...
    @ApiResponses({
        @ApiResponse(code = 200, message = "An Festivity from given Id"),
        @ApiResponse(code = 400, message = "Bad Request"),
        @ApiResponse(code = 401, message = "Unauthorized Request"),
        @ApiResponse(code = 404, message = "Festivity Not Found"),
        @ApiResponse(code = 500, message = "Unexpected Internal Server Error")
    ...
    public ResponseEntity<Festivity> festivity(
    	...
    	System.out.println("controller");
    	Optional<Festivity> festivity = service.findByid();
        ...
        throw new EntityNotFoundException("No Afiliado with Id [" + id + "] was not found!");
    }
    ...
    public void updateFestivity(
        @ApiParam(value = "The Afiliado Id", required = true) @PathVariable final String id, @RequestBody(required = true) FestivitieQueryDTO query
    ) {
    	Festivity festivity = Festivity.builder()
    ...
    public void deleteFestivity(
        @ApiParam(value = "The Afiliado Id", required = true) @PathVariable final String id
    ) {
